...
var resizePizzas = function(size) {
  ...
  function changePizzaSizes(size) {
    var hey = document.querySelectorAll(".randomPizzaContainer").length;
    for (var i = 0; i < hey; i++) {
...
function updatePositions() {
  ...
  var length = items.length; // added this to improve fps
  var body = document.body.scrollTop; //added to improve fps
